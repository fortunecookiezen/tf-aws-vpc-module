...
| <a name="input_isolated_subnet_suffix"></a> [isolated\_subnet\_suffix](#input\_isolated\_subnet\_suffix) | Suffix to append to outpost subnets name | `string` | `"isolated"` | no |
